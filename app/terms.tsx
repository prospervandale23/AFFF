...
You need to register for an account to access the app. By verifying your age. You are responsible for maintaining the confidentiality of your account credentials (passwords, emails, etc.) and for all actions that occur under your account.
...
5. Safety Disclaimer
Fishing involves physical activity and potential risks, as does meeting in person with strangers. Finnz is not liable for any injuries or accidents that may occur while fishing or meeting in-person with other users, regardless of the circumstances. 

6. Changes to Terms
We reserve the right to modify these Terms and Conditions at any time. We will notify users of any changes by updating the Terms on this page. Your continued use of the app after any changes constitutes acceptance of the new Terms.
`;
